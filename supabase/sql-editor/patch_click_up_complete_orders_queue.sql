-- =============================================================================
-- Complete Orders queue (Dispatch → Complete)
-- =============================================================================
-- Run in Supabase SQL Editor if migration 20260451 is not applied.
-- Requires public.click_up_dispatch_queue (patch_click_up_dispatch_queue.sql or migrations 20260450 + 20260455).
...
comment on table public.click_up_complete_orders_queue is
  'Admin Complete Orders list: row upserted when Dispatch uses Complete.';
