-- Logo file links on store_orders (multiple per type). Run once in Supabase SQL editor.
-- If you already ran an older version with single text columns, this upgrades them to text[].
