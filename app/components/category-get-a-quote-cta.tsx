...
/** CTA block at the top of storefront category browse pages — overlaps hero bottom by half on sm+ (`-mt-[17px]`, not transform, so tour highlight is not clipped). */
export function CategoryGetAQuoteCta() {
  return (
    <div className="category-quote-cta-shell mt-[7mm] flex justify-center overflow-visible pb-3 sm:mt-[-17px]">
      <a
