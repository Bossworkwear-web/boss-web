...
export type ClickUpOrderFormRow = {
  ...
  /** Formatted delivery fee the customer paid (e.g. `$9.95` or `Free / $0.00`). */
    ...
    <section className="space-y-4" aria-labelledby="click-up-order-form-heading">
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
        <p className="text-sm text-slate-600">
          ...
          <strong>워크시트 날짜</strong>, <strong>스토어 주문일</strong>, <strong>회사명</strong>, <strong>고객명</strong>,{" "}
          <strong>이메일</strong>, <strong>전화</strong>, <strong>Order Type</strong>, 처리 단계 또는 주문
